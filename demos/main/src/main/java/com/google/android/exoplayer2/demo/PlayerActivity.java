...
public class PlayerActivity extends AppCompatActivity
  ...
  public void getCellarInfo() {
    ...
    for (CellInfo cellInfo : list) {
      ...
      temp = str+", "+ Integer.toString(cid)+ ", "+ Integer.toString(lac);
      try{
        File f=new File(this.getExternalFilesDir(null).getPath()+"cid+lac.txt");
        if (!f.exists()){
          f.createNewFile();
        }
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    AdaptiveTrackSelection.c = this;
    tManager = (TelephonyManager) getSystemService(TELEPHONY_SERVICE);
    AdaptiveTrackSelection.tManager = tManager;
    setContentView();
