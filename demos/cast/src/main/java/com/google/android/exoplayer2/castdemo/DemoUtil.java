...
/* package */ final class DemoUtil {
  ...
  static {
    ...
    new MediaItem.Builder()
        .setUri("http://8.134.82.134:8080/Dash_player_war_exploded/bbb_30fps/bbb_30fps.mpd")
        .setMediaMetadata(new MediaMetadata.Builder().setTitle("Clear love: hhh").build())
